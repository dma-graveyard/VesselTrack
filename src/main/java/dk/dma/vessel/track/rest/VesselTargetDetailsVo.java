...
/**
 * Vessel target details value object
 */
@SuppressWarnings("unused")
public class VesselTargetDetailsVo implements JsonSerializable {
     ...
     */
    public VesselTargetDetailsVo(VesselTarget t) {
        mmsi = t.getMmsi();
